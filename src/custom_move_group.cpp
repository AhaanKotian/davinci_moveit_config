...
{
  ros::init(argc, argv, "custom_move_group");
  ...
  static const std::string PLANNING_GROUP = "psm1";
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools("suj_psm1_L0");
  ...
  visual_tools.publishText(text_pose, "MoveGroupInterface Custom", rvt::WHITE, rvt::XLARGE);
